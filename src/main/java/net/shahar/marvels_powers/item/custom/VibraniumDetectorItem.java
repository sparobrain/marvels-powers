package net.shahar.marvels_powers.item.custom;
...
public class VibraniumDetectorItem extends Item {
    public VibraniumDetectorItem(Properties properties) {
        super(properties);
    }
    ...
    private void outputValubleCoordinates(BlockPos blockPos,Player player, Block block) {
        player.sendSystemMessage(Component.literal("Found" + I18n.get(block.getDescriptionId()) + " as " +
